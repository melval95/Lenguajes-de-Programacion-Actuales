(function () {
    //Objeto con las propiedades del efecto parallax
    var propParallax = {
    ...
    //Objeto con los metodos del efecto parallax
    var metParallax = {
        inicio: function () {
        ...
        scrollParallax: function () {       
            ...
            if (propParallax.recorrido > propParallax.seccion.offsetTop - window.outerHeight &&
