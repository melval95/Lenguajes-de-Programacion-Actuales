(function () {
    //Objeto con las propiedades del efecto Scroll
    var propScroll = {
    ...
    //Metodos con Propiedades del efecto scroll
    var metScroll = {
        inicio: function () {
        ...
        moverse: function (e) {
            ...
            propScroll.seccion_distancia = document.querySelector(propScroll.destino).offsetTop - 80;
